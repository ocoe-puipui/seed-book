...
STRINGS = {
    "ja": {
        ...
        "dialog.rename_table.hint_default": "行を選択すると、下の「名前」欄で変更後の名前を編集できます。",
        "dialog.rename_table.hint_filename": "行を選択すると、下の「名前」欄で変更後のファイル名を編集できます（拡張子は自動的に付きます）。",
        ...
        "settings.theme.title": "外観モード",
        "settings.theme.auto": "自動（macOSの設定に追従）",
        ...
        "settings.naming.show_edit_dialog_checkbox": "リネーム時に編集画面を表示する",
        ...
        "settings.naming.save_button": "自動採番ルールを保存",
        ...
        "settings.naming.preview_prefix": "自動採番（次回以降）: ",
        ...
        "settings.reading_defaults.pattern_b": "右開き（右から左へ読む）",
        "settings.reading_defaults.center_align_checkbox": "既定で左右のページを画面中央で突き合わせる",
        ...
        "settings.database.create_button": " データベースを作成",
        "settings.database.create_tooltip": "新しいデータベースを作成します\n（例: image_metadata2.db）",
        "settings.database.switch_button": "データベースを変更",
        ...
        "settings.database.reset_button": " 選択中のデータベースをリセット",
        ...
        "metadata.button.save": " 変更を保存（名前・プロンプト）",
        "metadata.button.save_plain": "変更を保存（名前・プロンプト）",
        ...
        "menu.copy_file_suffix": "（他アプリに貼り付け可能）",
    ...
    "en": {
        "language.auto": "Auto (follow OS language setting)",
        "language.ja": "Japanese",
        "language.en": "English",
        "language.group_title": "Display Language",
        "language.restart_notice": "The display language change will take effect after restarting the app.",
        ...
        "dialog.rename_table.hint_default": "Select a row to edit its new name in the \"Name\" field below.",
        "dialog.rename_table.hint_filename": "Select a row to edit its new filename in the \"Name\" field below (the extension is added automatically).",
        ...
        "settings.theme.title": "Appearance Mode",
        "settings.theme.auto": "Auto (follow macOS setting)",
        "settings.theme.dark": "Always Dark",
        "settings.theme.light": "Always Light",
        "settings.panel.standard": "Standard (search/list on the left)",
        "settings.panel.mirrored": "Mirrored (search/list on the right)",

        # --- Settings dialog: folder import order ---
        "settings.import_order.title": "Folder Import Order",
        "settings.import_order.always_confirm": "Confirm every time",
        "settings.import_order.auto_last_used": "Automatically use last-used order",

        # --- Settings dialog: auto-numbering / renaming ---
        "settings.naming.title": "Auto-Numbering / Renaming",
        "settings.naming.auto_number_checkbox": "Auto-number new imports",
        ...
        "settings.naming.show_edit_dialog_checkbox": "Show edit dialog when renaming",
        ...
        "settings.naming.save_button": "Save Auto-Numbering Rule",
        ...
        "settings.naming.preview_prefix": "Auto-numbering (from now on): ",
        ...
        "settings.display_fields.title": "Display Fields (generation parameters to add below the model field)",
        "settings.reading_defaults.title": "Reading Mode (Spread View) Defaults",
        "settings.reading_defaults.pattern_a": "Left-bound (read left to right)",
        "settings.reading_defaults.pattern_b": "Right-bound (read right to left)",
        "settings.reading_defaults.center_align_checkbox": "Center-align left/right pages by default",
        ...
        "settings.database.current_label": "Currently in use: {db_name}",
        "settings.database.open_folder_tooltip": "Open the database's storage folder",
        "settings.database.create_button": " Create Database",
        "settings.database.create_tooltip": "Creates a new database\n(e.g. image_metadata2.db)",
        "settings.database.switch_button": "Switch Database",
        ...
        "settings.database.reset_button": " Reset Selected Database",
        ...
        "metadata.button.save": " Save Changes (Name/Prompt)",
        "metadata.button.save_plain": "Save Changes (Name/Prompt)",
        ...
        "menu.copy_file_suffix": " (can be pasted into other apps)",
